...
# 英雄类别权重（按训练集样本量反比，样本少的英雄给更高权重）
# 训练集分布: Aphelios=22 Syndra=27 Nunu=38 Mordekaiser=38 Fiddlesticks=44 Leona=45 Janna=54 Urgot=63
HERO_CLASS_WEIGHTS = [2.8, 2.3, 1.6, 1.6, 1.4, 1.4, 1.2, 1.0]
